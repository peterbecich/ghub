...
#+SUBTITLE: for version 1.3.0 (v1.3.0-25-gc2cbe1d+1)
...
#+BEGIN_QUOTE
This manual is for Ghub version 1.3.0 (v1.3.0-25-gc2cbe1d+1).
...
Most packages should only need the ~repo~ scope. The meaning of the
various scopes are documented at <https://magit.vc/goto/f63aeb0a>.
